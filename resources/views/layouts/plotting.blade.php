                        ...
                        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            <div
                                ...
                                <div class="relative m-2">
                                    <button id="tambah-dosenwaliModalButton" data-modal-target="tambah-dosenwaliModal"
                                        data-modal-toggle="tambah-dosenwaliModal"
                                ...
                                <div class="relative m-2">
                                    <button id="tambah-mahasiswaModalButton" data-modal-target="tambah-mahasiswaModal"
                                        data-modal-toggle="tambah-mahasiswaModal"
                                        class="flex items-center text-blue-800 hover:text-white border border-white-400  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-yellow-4400 dark:text-white-400 dark:hover:text-blue dark:hover:bg-blue-800 dark:focus:ring-blue-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-7 -ml-0.5"
                                            viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path
                                        ...
                                        <div
                                            ...
                                            <div class="flex-1 flex flex-col items-start space-y-3">
                                                <div class="flex-1 flex items-center space-x-3">
                                                    <h5>
                                                        <span class="text-blue-500 font-bold">Kelas A</span>
                                                    </h5>
                                                </div>
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div class="flex items-center space-x-4">
                                                                        ...
                                                                        <button type="button"
                                                                            data-modal-target="keluarkan-modal"
                                                                            data-modal-toggle="keluarkan-modal"
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <th scope="row"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <input type="date"
                                                                                                value="2003-04-07"
                                                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                                                        </div>
                                                                                    </th>
                                                                                    <td
                                                                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
